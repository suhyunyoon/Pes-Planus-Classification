...
from dataset_rsdb import CombinationDataset
...
def run(args):
    ...
    elif args.dataset == 'foot_combination':
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", default="foot_combination", type=str, choices=['foot', 'pressure', 'point', 'foot_combination'])
